...
"""
Loop through images of forms and attempt to slice 
"""
...
for folder in os.listdir(PathStorage.completed_path):
    ...
    for file in os.listdir(folder_path):
        if file.split(".")[-1] == "pdf":
            ...
            sliced = split(array, .26, .33, .2, .3)

            img_path = os.path.join(PathStorage.pdf_renewal_dataset, subfolder, "{:05d}".format(png_index) + "_" + file.split(".")[0] + ".png")
